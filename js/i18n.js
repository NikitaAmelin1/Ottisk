...
(function attachOttiskI18n(root) {
  ...
  const STRINGS = {
    ru: {
      ...
      admin_lead: "полный доступ · только для владельца",
      admin_enter: "режим администратора",
      admin_gate_lead: "Введи код оттиск — панель откроется сразу",
      admin_code: "Код",
      admin_code_bad: "Неверный код. Попробуй: оттиск",
      admin_unlock_btn: "Открыть админку",
      admin_via_auth: "Через регистрацию",
      admin_via_auth_hint: "Зарегистрируйся — откроется админка",
      admin_marks: "+1000 следов",
      admin_unlock: "Открыть всё",
      admin_best: "Рекорд 999",
      admin_god: "бессмертие",
      admin_god_on: "бессмертие вкл",
      admin_god_off: "бессмертие выкл",
      admin_editor: "Редактор",
      admin_home: "На главную",
      admin_chip: "админ",
    ...
    en: {
      ...
      admin_lead: "full access · owner only",
      admin_enter: "admin mode",
      admin_gate_lead: "Enter code ottisk — panel opens right away",
      admin_code: "Code",
      admin_code_bad: "Wrong code. Try: ottisk",
      admin_unlock_btn: "Open admin",
      admin_via_auth: "Via sign-up",
      admin_via_auth_hint: "Sign up — admin panel opens",
      admin_marks: "+1000 marks",
      admin_unlock: "Unlock all",
      admin_best: "Best 999",
      admin_god: "immortal",
      admin_god_on: "immortal on",
      admin_god_off: "immortal off",
      admin_editor: "Editor",
      admin_home: "Home",
      admin_chip: "admin",
