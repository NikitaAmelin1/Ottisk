...
(function attachOttiskI18n(root) {
  ...
  const STRINGS = {
    ru: {
      ...
      accessibility_quality: "Доступность и качество",
      new_run_sub: "новый забег",
      menu_sub: "на главный экран",
      share_sub: "Stories · волна и герой",
      ...
      daily_gift_cta: "Забрать подарок {title} {amount}",
      gift_ready: "Подарок готов",
      gift_next: "Подарок через {time}",
      gifts: "Подарки",
      claim: "Получить",
      ...
      cloud_account_required: "Сервер настроен · нужен аккаунт",
      ...
      cloud_local_board: "Локальный рейтинг",
      local_board_help: "Лучшие результаты на этом устройстве.",
      ...
      share: "Поделиться",
      watch_best: "Смотреть лучший забег",
      best_path: "лучший след",
      next_goal: "следующая цель",
      retry: "Ещё раз",
      menu: "В меню",
      rate_app: "Оценить",
      buy_marks: "Купить следы",
      ...
      advanced_cloud: "Расширенные настройки облака",
      save_url: "Сохранить URL",
    ...
    en: {
      ...
      accessibility_quality: "Accessibility and quality",
      new_run_sub: "new run",
      menu_sub: "main screen",
      share_sub: "Stories · wave and hero",
      ...
      daily_gift_cta: "Claim gift {title} {amount}",
      gift_ready: "Gift ready",
      gift_next: "Next gift in {time}",
      gifts: "Gifts",
      claim: "Claim",
      claim_all: "Claim all",
      claimed: "Claimed",
      ...
      cloud_account_required: "Server configured · account required",
      ...
      cloud_local_board: "Local leaderboard",
      local_board_help: "Best results on this device.",
      ...
      best_path: "best trail",
      next_goal: "next goal",
      retry: "Again",
      menu: "Menu",
      rate_app: "Rate the app",
      buy_marks: "Buy trails",
      ...
      open_shop: "Open shop",
      donate: "Donate",
      for_authors: "For creators",
      advanced_cloud: "Advanced cloud settings",
      save_url: "Save URL",
      terms: "Terms of use",
    },
  };
